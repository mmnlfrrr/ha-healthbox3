...
const CASES = {
  "single outlets": [room(1, "Bathroom", "healthbox:bath"),
                     room(2, "Toilet", "healthbox:toilet"),
                     room(6, "Kitchen", "healthbox:kitchen")],
  "chain right": [...chain(2, 2, "Bedroom", "healthbox:bed"),
                  room(6, "Kitchen", "healthbox:kitchen")],
  "chain left": [...chain(6, 3, "Office", "healthbox:office", 1),
                 room(1, "Bathroom", "healthbox:bath")],
  "chain top": [...chain(7, 2, "Attic", "healthbox:storage"),
                room(2, "Toilet", "healthbox:toilet")],
  "chain bottom": [...chain(3, 2, "Basement", "healthbox:basement", 0),
                   room(6, "Kitchen", "healthbox:kitchen")],
  "every port chained": [...chain(1, 3, "A", "healthbox:bath"),
                         ...chain(2, 2, "B", "healthbox:toilet"),
                         ...chain(3, 2, "C", "healthbox:basement"),
                         ...chain(4, 3, "D", "healthbox:washing", 2),
                         ...chain(5, 2, "E", "healthbox:dresser"),
                         ...chain(6, 3, "F", "healthbox:kitchen"),
                         ...chain(7, 2, "G", "healthbox:storage")],
  "one room only": [room(4, "Laundry", "healthbox:washing")],
};
