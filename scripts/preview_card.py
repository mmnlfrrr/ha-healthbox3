...
const CASES = {
  "single outlets": [room(1, "Bathroom", "renson:bath"),
                     room(2, "Toilet", "renson:toilet"),
                     room(6, "Kitchen", "renson:kitchen")],
  "chain right": [...chain(2, 2, "Bedroom", "renson:bed"),
                  room(6, "Kitchen", "renson:kitchen")],
  "chain left": [...chain(6, 3, "Office", "renson:office", 1),
                 room(1, "Bathroom", "renson:bath")],
  "chain top": [...chain(7, 2, "Attic", "renson:storage"),
                room(2, "Toilet", "renson:toilet")],
  "chain bottom": [...chain(3, 2, "Basement", "renson:basement", 0),
                   room(6, "Kitchen", "renson:kitchen")],
  "every port chained": [...chain(1, 3, "A", "renson:bath"),
                         ...chain(2, 2, "B", "renson:toilet"),
                         ...chain(3, 2, "C", "renson:basement"),
                         ...chain(4, 3, "D", "renson:washing", 2),
                         ...chain(5, 2, "E", "renson:dresser"),
                         ...chain(6, 3, "F", "renson:kitchen"),
                         ...chain(7, 2, "G", "renson:storage")],
  "one room only": [room(4, "Laundry", "renson:washing")],
};
